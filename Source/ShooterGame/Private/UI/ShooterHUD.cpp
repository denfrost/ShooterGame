...
AShooterHUD::AShooterHUD(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	static ConstructorHelpers::FObjectFinder<UTexture2D> HitTextureOb(TEXT("/ShooterGame/UI/HUD/HitIndicator"));
	...
	#if !UE_SERVER
	{
		static ConstructorHelpers::FObjectFinder<UFont> BigFontOb(TEXT("/ShooterGame/UI/HUD/Roboto51"));
		static ConstructorHelpers::FObjectFinder<UFont> NormalFontOb(TEXT("/ShooterGame/UI/HUD/Roboto18"));
