...
{
	static ConstructorHelpers::FClassFinder<APawn> PlayerPawnOb(TEXT("/ShooterGame/Blueprints/Pawns/PlayerPawn")); //Blueprint'/ShooterGame/Blueprints/Pawns/PlayerPawn.PlayerPawn'
	DefaultPawnClass = PlayerPawnOb.Class;
	
	static ConstructorHelpers::FClassFinder<APawn> BotPawnOb(TEXT("/ShooterGame/Blueprints/Pawns/BotPawn")); ///Game/Blueprints/Pawns/BotPawn
...
void AShooterGameMode::InitGame(const FString& MapName, const FString& Options, FString& ErrorMessage)
{
	...
	if (GameInstance && Cast<UShooterGameInstance>(GameInstance)->GetOnlineMode() != EOnlineMode::Offline) // Get Something from config!
	{
		bPauseable = false;
	}
}
