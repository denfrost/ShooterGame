...
public:
	...
	{
		static const FName LoadingScreenName(TEXT("/ShooterGame/UI/Menu/LoadingScreen.LoadingScreen"));
...
public:
	...
	{		
		...
		LoadObject<UObject>(NULL, TEXT("/ShooterGame/UI/Menu/LoadingScreen.LoadingScreen") );
